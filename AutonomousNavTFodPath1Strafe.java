...
@Autonomous(name="AutonomousNavTFodPath1Strafe", group="Autonomous")

public class AutonomousNavTFodPath1Strafe extends LinearOpMode {
        ...
        */
        ...
        while (opModeIsActive() && !amIDone) {
            ...
            for (int i = 0; i < filteredMinerals.size(); i++) {
                if ((filteredMinerals.get(i).getRight() - filteredMinerals.get(i).getLeft() < 100) || (filteredMinerals.get(i).getBottom() < 650)) { //if the size of the box is less than 100, then it's in the background so its removed
                ...
                if (targetVisible) {
                    switch (picture_found) {
                        case 0:
                            ...
                            turnDegrees(10);
                            strafeDrive(0.5, -strafeCount - 51, 6);
                            depositMarker();
                        ...
                        turnDegrees(-(rotation.thirdAngle));*/
                            ...
                            //moveForward(-3);
                            turnDegrees(10);
                            strafeDrive(0.5, 48 + strafeCount, 6);
                            turnDegrees(-7);
                            moveForward(-1);
                        /*moveForward(43.5);
