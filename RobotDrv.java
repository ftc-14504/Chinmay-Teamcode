...
public class RobotDrv
{
    ...
    public void initDrive(LinearOpMode opMode) {
        ...
        leftDrive        = myOpMode.hardwareMap.get(DcMotor.class, "left");
        rightDrive       = myOpMode.hardwareMap.get(DcMotor.class, "right");
        ...
        BNO055IMU imu = myOpMode.hardwareMap.get(BNO055IMU.class, "imu");
        robotImu = new RobotImu(imu);
    }

    public void manualDrive()  {

        setAxial(myOpMode.gamepad1.right_stick_y);
    ...
    public void moveRobot() {
        ...
        /*// start rotating robot in direction of hypotenuse of axial and lateral
        double angle = Math.atan2(driveAxial, driveLateral)*180 / Math.PI;
        double turnPowRight = 0;
        double turnPowLeft = 0;
        if (angle > 0) turnPowRight = 0.4;
        else turnPowLeft = -0.4;
        robotImu.setAngles();
        while (Math.abs(robotImu.heading() - angle) > 1) {
            leftDrive.setPower(turnPowLeft);
            rightDrive.setPower(turnPowRight);
        }*/
